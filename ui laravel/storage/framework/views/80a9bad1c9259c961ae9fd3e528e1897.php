<?php $__env->startSection('title', 'Nilai Individu Penguji 2'); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center"
                                                            ...
                                                            <?php if($nilai): ?>
                                                                <form
                                                                    action="<?php echo e(route('penguji2.NilaiIndividu.destroy', $nilai->id)); ?>"
                                                        ...
                                                        <div class="collapse" id="nilai<?php echo e($mhs->user_id); ?>">
                                                            ...
                                                            <div class="card m-3 shadow-sm">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <form
                                                                        action="<?php echo e($nilai ? route('penguji2.NilaiIndividu.update', $nilai->id) : route('penguji2.NilaiIndividu.store')); ?>"
                                                                        method="POST">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Penguji/Nilai_Individu/indexp2.blade.php ENDPATH**/ ?>
    ...
    <?php $__env->startSection('title', 'Tambah Pengajuan Seminar'); ?>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('PengajuanSeminar.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label for="kelompok_id">Kelompok</label>
                                    <input type="hidden" name="kelompok_id" value="<?php echo e($kelompok->id); ?>">
                                    <input type="text" class="form-control" value="Kelompok <?php echo e($kelompok->nomor_kelompok); ?>" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="pembimbing_id">Pembimbing</label>
                                    <input type="hidden" name="pembimbing_id" value="<?php echo e($pembimbing->id); ?>">
                                    <input type="text" class="form-control" value="<?php echo e($pembimbing->nama); ?>" readonly>
                                </div>
                                    ...
                                    <div id="upload-instructions">
                                        ...
                                        <label class="btn btn-outline-primary">
                                            ...
                                            <input type="file" name="files[]" id="files"
                                                class="d-none <?php $__errorArgs = ['files'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Mahasiswa/Pengajuan_Seminar/create.blade.php ENDPATH**/ ?>
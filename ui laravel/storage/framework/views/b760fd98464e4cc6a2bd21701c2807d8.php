                                ...
                                <div class="col-12">
                                    <?php $__currentLoopData = $artefak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <ul class="nav nav-tabs mb-4" style="border-bottom: 1px solid #ddd;">
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="<?php echo e(route('artefak.index')); ?>">
                                                    PENGUMPULAN BERKAS
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="<?php echo e(route('status_perizinan')); ?>">
                                                    STATUS PERIZINAN MAJU SEMINAR
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="<?php echo e(route('jadwal.seminar')); ?>">
                                                    JADWAL SEMINAR
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="<?php echo e(route('feedback.show', Crypt::encrypt($item->id))); ?>">
                                                    FEEDBACK
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="<?php echo e(route('revisi.index')); ?>">
                                                    BERKAS FINAL
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="card mb-4 shadow-sm border">
                                                    <div class="card-body">
                                                        <h5 class="card-title font-weight-bold"><?php echo e($item->Judul_Tugas); ?>
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                ...
                                                                <span
                                                                    class="text-danger"><?php echo e($item->formatted_deadline); ?></span>
                                                            </li>
                                                        </ul>
                                                        <div class="mb-2">
                                                            <span
                                                                class="badge badge-<?php echo e($status ? 'success' : 'secondary'); ?>">
                                                                <?php echo e($status ? $status->status : 'Belum dikumpulkan'); ?>

                                                            </span>
                                                            <a href="<?php echo e(route('artefak.create', Crypt::encrypt($item->id))); ?>"
                                                ...
                                                <?php if($artefak->isEmpty()): ?>
                                                    <div class="alert alert-info">Tidak ada tugas yang tersedia.</div>
                                                <?php endif; ?>

                                                
                                                <?php if($status && $status->status === 'Submitted'): ?>
                                                    <?php if($pengajuanSeminars->isEmpty()): ?>
                                                        <div class="text">
                                                            <a href="<?php echo e(route('PengajuanSeminar.create')); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        <?php $__currentLoopData = $pengajuanSeminars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($item->status == 'menunggu'): ?>
                                                                <a href="<?php echo e(route('PengajuanSeminar.edit', Crypt::encrypt($item->id))); ?>"
                                                                    class="btn btn-sm btn-primary mr-2">Edit Pengajuan
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <form method="POST"
                                                                    action="<?php echo e(route('PengajuanSeminar.destroy', Crypt::encrypt($item->id))); ?>"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Mahasiswa/Artefak/index.blade.php ENDPATH**/ ?>
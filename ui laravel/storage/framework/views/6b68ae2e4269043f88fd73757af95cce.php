            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                         ...
                         <input type="hidden" name="TM_id" value="<?php echo e($TM_id); ?>">
                          
                          <input type="hidden" name="KPA_id" value="<?php echo e($KPA_id); ?>">
                           
                         <input type="hidden" name="prodi_id" value="<?php echo e($prodi_id); ?>">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Koordinator/pengumuman/create.blade.php ENDPATH**/ ?>
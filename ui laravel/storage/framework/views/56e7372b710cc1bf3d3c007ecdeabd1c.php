<?php $__env->startSection('title', 'Nilai Kelompok Penguji 1'); ?>
<style>
    .toggle-collapse,
    .show_confirm {
        min-width: 115px;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        <?php if($nilai): ?>
                                                            <form
                                                                action="<?php echo e(route('penguji1.NilaiKelompok.destroy', $nilai->id)); ?>"
                                                    ...
                                                    <div class="collapse" id="nilaiKelompok<?php echo e($item->id); ?>">
                                                        ...
                                                        <div class="card m-3 shadow-sm">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="<?php echo e($nilai ? route('penguji1.NilaiKelompok.update', $nilai->id) : route('penguji1.NilaiKelompok.store')); ?>">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Penguji/Nilai_Kelompok/index.blade.php ENDPATH**/ ?>
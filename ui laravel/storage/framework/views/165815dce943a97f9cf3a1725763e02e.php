<?php $__env->startSection('title', 'Nilai Bimbingan'); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <div class="d-flex" style="gap: 8px;">
                                                            ...
                                                            <?php if($nilai): ?>
                                                                <form
                                                                    action="<?php echo e(route('pembimbing1.NilaiBimbingan.destroy', $nilai->id)); ?>"
                                                        ...
                                                        <div class="collapse" id="nilai<?php echo e($mhs->user_id); ?>">
                                                            ...
                                                            <div class="card m-3 shadow-sm">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <form
                                                                        action="<?php echo e($nilai ? route('pembimbing1.NilaiBimbingan.update', $nilai->id) : route('pembimbing1.NilaiBimbingan.store')); ?>"
                                                                        method="POST">
                                                                        ...
                                                                        <?php $__currentLoopData = $komponenNilai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Pembimbing/Nilai_Individu/indexp3.blade.php ENDPATH**/ ?>
    ...
    <?php $__env->startSection('title', 'Revisi'); ?>
                                    ...
                                    <div class="card mb-4 shadow-sm border">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <a href="<?php echo e(route('artefak.create', Crypt::encrypt($item->id))); ?>" class="btn btn-sm btn-primary ml-2">Lihat Detail</a>
                                            </div>
                                            <div class="mb-2 <?php echo e($item->status_class); ?>">
                                                ⏳ <span class="countdown" data-deadline="<?php echo e($item->tanggal_pengumpulan); ?>"></span>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Mahasiswa/Artefak/revisi.blade.php ENDPATH**/ ?>
            ...
            <div class="col-14 col-md-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <?php if(!$hasSubmitted): ?>
                                <form method="POST" action="<?php echo e(route('artefak.submit', $tugas->id)); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="text-right">
                                    <a href="<?php echo e(route('artefak.edit', Crypt::encrypt($existingSubmission->id))); ?>" class="btn btn-warning">Edit File</a>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Mahasiswa/Artefak/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Nilai Individu Pembimbing 2'); ?>
<style>
    .toggle-collapse,
    .show_confirm {
        min-width: 115px;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center"
                                                            ...
                                                            <?php if($nilai): ?>
                                                                <form
                                                                    action="<?php echo e(route('pembimbing2.NilaiIndividu.destroy', $nilai->id)); ?>"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Pembimbing/Nilai_Individu/indexp2.blade.php ENDPATH**/ ?>
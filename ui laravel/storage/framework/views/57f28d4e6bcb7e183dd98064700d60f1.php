        ...
        <div class="section-header">
            <h1>
                ...
                <span style="color: #4C9BC8;">
                    <?php echo e(str_replace('PA-', 'PA ', $kpa->kategori_pa)); ?>
                        ...
                        <div class="card-body">
                            <div class="verification-flow-container d-flex align-items-stretch justify-content-between flex-wrap"
                                ...
                                <div class="verification-step flex-fill" data-step="kelompok"
                                    data-status="<?php echo e($verification_status['kelompok'] ?? 'pending'); ?>"
                                    ...
                                    <div class="step-label">
                                        ...
                                        <div class="wa-btn-wrapper" style="margin-top: 8px; display: none;">
                                            <form action="<?php echo e(route('whatsapp.sendtoMahasiswa')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                ...
                                <div class="verification-step flex-fill" data-step="pembimbing"
                                    data-status="<?php echo e($verification_status['pembimbing'] ?? 'pending'); ?>"
                                    style="min-width: 180px;">
                                    <div class="step-circle">
                                    ...
                                    <div class="step-label">
                                        ...
                                        <div class="wa-btn-wrapper" style="margin-top: 8px; display: none;">
                                            <form action="<?php echo e(route('whatsapp.sendtoPembimbing')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="pesan"
                                                    value="📢 *PENGUMUMAN PROYEK AKHIR*\n\nHalo Mahasiswa/Dosen,\n\nKelompok Proyek Akhir telah berhasil di-generate oleh sistem.\n\nSilakan cek detail pengumuman dan pembagian kelompok pada website *Vokasi Tera*.\n\nTerima kasih ">
                                                <button type="submit" class="btn-wa">
                                ...
                                <div class="verification-step flex-fill" data-step="penguji"
                                    data-status="<?php echo e($verification_status['penguji'] ?? 'pending'); ?>"
                                    style="min-width: 180px;">
                                    <div class="step-circle">
                                    ...
                                    <div class="step-label">
                                        ...
                                        <div class="wa-btn-wrapper" style="margin-top: 8px; display: none;">
                                            <form action="<?php echo e(route('whatsapp.sendtoPenguji')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="pesan"
                                                    value="📢 *PENGUMUMAN PROYEK AKHIR*\n\nHalo Mahasiswa/Dosen,\n\nKelompok Proyek Akhir telah berhasil di-generate oleh sistem.\n\nSilakan cek detail pengumuman dan pembagian kelompok pada website *Vokasi Tera*.\n\nTerima kasih ">
                                                <button type="submit" class="btn-wa">
                                ...
                                <div class="verification-step flex-fill" data-step="jadwal"
                                    data-status="<?php echo e($verification_status['jadwal'] ?? 'pending'); ?>"
                                    style="min-width: 180px;">
                                    <div class="step-circle">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('detail.administratif')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <div class="dashboard-donut-legend mt-4">
                            <div class="donut-legend-item d-flex align-items-center mb-2">
                                ...
                                <span>Selesai</span>
                                <span class="ml-auto font-weight-bold"><?php echo e($stat_lengkap ?? 78); ?></span>
                            </div>
                            <div class="donut-legend-item d-flex align-items-center mb-2">
                                <span class="donut-legend-dot mr-2" style="background:#f59e0b;"></span>
                                <span>Sedang Progress</span>
                                <span class="ml-auto font-weight-bold"><?php echo e($stat_menunggu ?? 32); ?></span>
                            </div>
                            <div class="donut-legend-item d-flex align-items-center">
                                ...
                                <span class="ml-auto font-weight-bold"><?php echo e($stat_belum ?? 14); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dashboard-progress-list">
                            ...
                            ?>
                            <?php $__currentLoopData = $top_kelompok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="dashboard-progress-item mb-3">
                                    <div class="d-flex justify-content-between mb-1">
                                        <span style="font-size:13px;font-weight:600;"><?php echo e($k['nama']); ?></span>
                                        <span style="font-size:13px;font-weight:700;"><?php echo e($k['nilai']); ?></span>
                                    </div>
                                    <div class="progress" style="height:10px;border-radius:99px;">
                                        <div class="progress-bar bg-primary" role="progressbar"
                                            style="width:<?php echo e($k['nilai']); ?>%;border-radius:99px;"
                                            aria-valuenow="<?php echo e($k['nilai']); ?>" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0" id="tabelMonitoring">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $daftar_kelompok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelompok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="font-weight-600 py-3">
                                                Kelompok <?php echo e($kelompok->nomor_kelompok); ?>
                                            ...
                                            <td class="py-3">
                                                <span class="badge badge-success px-3 py-2"
                                                    ...
                                                    <?php echo e($kelompok->status); ?>

                                                </span>
                                            </td>

                                            <td class="text-center py-3">
                                                <?php echo e($kelompok->jumlah_bimbingan_selesai); ?> / 12
                                            </td>

                                            <td class="text-center py-3">
                                                <?php echo e(number_format($kelompok->rata_nilai_akhir ?? 0, 1)); ?>

                                            </td>

                                            <td class="py-3">
                                                <?php if($kelompok->jadwal): ?>
                                                    <span style="color:#16a34a;font-size:12px;font-weight:600;">
                                                        <i class="fas fa-circle mr-1" style="font-size:7px;"></i>
                                                        <?php echo e(\Carbon\Carbon::parse($kelompok->jadwal->waktu_mulai)->format('d M Y H:i')); ?>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        function refreshVerificationStatus() {
            ...
            fetch('<?php echo e(route('koordinator.getVerificationStatus')); ?>', {
                    method: 'GET',
                    headers: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var initialStatus = <?php echo json_encode($verification_status ?? [], 15, 512) ?>;
            ...
            if (donutEl) {
                new Chart(donutEl, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo e($stat_lengkap ?? 78); ?>,
                                <?php echo e($stat_menunggu ?? 32); ?>,
                                <?php echo e($stat_belum ?? 14); ?>
            ...
            if (barEl) {
                var barDataRaw = <?php echo json_encode($bar_data, 15, 512) ?>;
                var barColors = barDataRaw.map(v => v > 8 ? '#10b981' : '#f59e0b');

                new Chart(barEl, {
                    type: 'bar',
                    data: {
                        labels: <?php echo json_encode($bar_labels, 15, 512) ?>,
                        datasets: [{
                ...
                new Chart(histEl, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: <?php echo json_encode($dist_nilai, 15, 512) ?>,
            ...
            if (lineEl) {
                new Chart(lineEl, {
                    type: 'line',
                    data: {
                        labels: <?php echo json_encode($tren_labels, 15, 512) ?>,
                        datasets: [{
                            label: 'Rata-rata Nilai',
                            data: <?php echo json_encode($tren_data, 15, 512) ?>,
                            borderColor: '#002045',
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Koordinator/dashboard.blade.php ENDPATH**/ ?>
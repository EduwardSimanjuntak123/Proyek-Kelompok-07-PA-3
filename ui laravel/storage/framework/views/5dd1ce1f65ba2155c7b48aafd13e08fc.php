<?php $__env->startSection('title', 'Nilai Kelompok Penguji 2'); ?>
<style>
    .toggle-collapse,
    .show_confirm {
        min-width: 115px;
                                        ...
                                        <?php $__currentLoopData = $kelompok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        <button
                                                            class="btn btn-sm <?php echo e($nilai ? 'btn-success' : 'btn-primary'); ?> toggle-collapse d-flex align-items-center"
                                                            type="button" data-toggle="collapse"
                                                            data-target="#nilaiKelompok<?php echo e($item->id); ?>"
                                                            aria-expanded="false">

                                                            <i class="fas fa-chevron-down mr-1"></i>

                                                            <?php echo e($nilai ? 'Edit Nilai' : 'Beri Nilai'); ?>
                                                        ...
                                                        <?php if($nilai): ?>
                                                            <form
                                                                action="<?php echo e(route('penguji2.NilaiKelompok.destroy', $nilai->id)); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" class="p-0 border-0">
                                                    ...
                                                    <div class="collapse" id="nilaiKelompok<?php echo e($item->id); ?>">
                                                        ...
                                                        <div class="card m-3 shadow-sm">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="<?php echo e($nilai ? route('penguji2.NilaiKelompok.update', $nilai->id) : route('penguji2.NilaiKelompok.store')); ?>">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Semester 6\PA III\Project\Proyek-Kelompok-07-PA-3\ui laravel\resources\views/pages/Penguji/Nilai_Kelompok/indexp2.blade.php ENDPATH**/ ?>